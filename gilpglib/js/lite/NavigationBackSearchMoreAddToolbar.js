...
import { NavigationBackSearchMoreAddToolbarGroup } from "./NavigationBackSearchMoreAddToolbarGroup.js"
import {
 ...
 *  }>[]} contents
 */
export function NavigationBackSearchMoreAddToolbar({
 backHref, newHref, header, readMoreHidden, readMoreListener
}, ...contents) {
 return executeLiteGroupFilterFunctions(NavigationBackSearchMoreAddToolbarGroup(
