...
/** @type {HTMLInputElement} */ const codeShow = querySelector(document, "#codeShow");
/** @type {HTMLIFrameElement} */ const iframe = querySelector(document, "iframe");
/** @type {HTMLOutputElement} */ const windowTitle = querySelector(document, "#windowTitle");
/** @type {HTMLInputElement} */ const windowShow = querySelector(document, "#windowShow");
/** @type {HTMLInputElement} */ const consoleShow = querySelector(document, "#consoleShow");
const consoleSec = querySelector(document, "#consoleSec");
const consoleElement = querySelector(document, "pre");
let editor = new (0, _view.EditorView)({
    doc: "hello",
    extensions: [
...
function ejecuta() {
    // @ts-ignore
    const src = editor.getValue().replace(/* html */ `</title>`, /* html */ `</title><script src="adapta.js"></script>`);
    iframe.srcdoc = src;
}
function archivoAbre() {
    ...
    if (selecci\u00f3n) {
        ...
        reader.onerror = ()=>{
            if (reader.error) errorMuestra(reader.error);
        };
...
/** @param {string} texto */ function guardarActualiza(texto) {
    if (guardar) guardar.href = URL.createObjectURL(new Blob([
        texto
    ], {
        type: "text/html"
    }));
}
/** @param {DOMException} e */ function errorMuestra(e) {
    console.log(e);
    alert(e.message);
}
...
},{"@codemirror/view":"c2noD","@codemirror/commands":"5nDyv"}],"c2noD":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "BlockWrapper", ()=>BlockWrapper);
...
parcelHelpers.export(exports, "getDialog", ()=>getDialog);
...
parcelHelpers.export(exports, "showDialog", ()=>showDialog);
...
*/ class BlockWrapper extends (0, _state.RangeValue) {
...
const blockWrappers = /*@__PURE__*/ (0, _state.Facet).define();
...
class WidgetTile extends Tile {
    ...
    get overrideDOMText() {
        if (!this.length) return (0, _state.Text).empty;
        let { root } = this;
        if (!root) return (0, _state.Text).empty;
...
class TileBuilder {
    ...
    blockPosCovered() {
        ...
        return last != null && !last.breakAfter && (!last.isWidget() || (last.flags & 160 /* TileFlag.IncEnd */ ) > 0);
    }
    getBuffer(side) {
...
class TileUpdate {
    constructor(view, old, blockWrappers, decorations, disallowBlockEffectsFor){
        ...
        this.builder = new TileBuilder(this.cache, new DocTile(view, view.contentDOM), (0, _state.RangeSet).iter(blockWrappers));
    ...
    emit(from, to) {
        ...
        let openEnd = (0, _state.RangeSet).spans(this.decorations, from, to, {
...
class DocView {
    ...
    update(update) {
        ...
        if (this.tile.flags & 2 /* TileFlag.Synced */  && changedRanges.length == 0) return false;
        else {
    ...
    inlineDOMNearPos(pos, side) {
        ...
        this.tile.blockTiles((tile, off)=>{
            if (tile.isWidget()) {
                if (tile.flags & 32 /* TileFlag.After */  && before) return true;
    ...
    coordsForChar(pos) {
        ...
        function scan(tile, offset) {
            if (tile.isComposite()) for (let ch of tile.children){
                ...
                let end = (0, _state.findClusterBreak)(tile.text, offset);
...
function moveVertically(view, start, forward, distance) {
    ...
    for(let extra = 0;; extra += 10){
        ...
        return (0, _state.EditorSelection).cursor(pos.pos, pos.assoc, undefined, goal);
    }
}
...
function posAtCoordsInline(view, tile, offset, x, y) {
    ...
    let checkRects = (rects, index)=>{
        for(let i = 0; i < rects.length; i++){
            ...
            if (closest < 0 || (dy - dyClosest || dx - dxClosest) < 0) {
                if (closest >= 0 && dyClosest && dxClosest < dx && closestRect.top <= rowBot - 2 && closestRect.bottom >= rowTop + 2) // Retroactively set dy to 0 if the current match is in this row.
                dyClosest = 0;
                else {
                    closest = index;
                    dxClosest = dx;
    ...
    if (tile.isText()) {
        for(let i = 0; i < tile.length;){
            let next = (0, _state.findClusterBreak)(tile.text, i);
        ...
        return after ? new PosAssoc(offset + (0, _state.findClusterBreak)(tile.text, closest), -1) : new PosAssoc(offset + closest, 1);
    } else {
...
class DOMReader {
    ...
    readRange(start, end) {
        ...
        for(let cur = start;;){
            ...
            if (next == end) {
                if ((tile === null || tile === void 0 ? void 0 : tile.breakAfter) && !next) this.lineBreak();
                break;
            }
...
function eventBelongsToEditor(view, event) {
    ...
    for(let node = event.target, tile; node != view.contentDOM; node = node.parentNode)if (!node || node.nodeType == 11 || (tile = Tile.get(node)) && tile.isWidget() && tile.widget.ignoreEvent(event)) return false;
    return true;
}
...
*/ function showDialog(view, config) {
    ...
    if (view.state.field(dialogField, false)) view.dispatch({
        effects: openDialogEffect.of(panelCtor)
    });
    else view.dispatch({
        effects: (0, _state.StateEffect).appendConfig.of(dialogField.init(()=>[
                panelCtor
            ]))
    });
...
const openDialogEffect = /*@__PURE__*/ (0, _state.StateEffect).define();
const closeDialogEffect = /*@__PURE__*/ (0, _state.StateEffect).define();
function createDialog(view, config, result) {
    let content = config.content ? config.content(view, ()=>done(null)) : null;
    if (!content) {
        content = (0, _creltDefault.default)("form");
        if (config.input) {
            let input = (0, _creltDefault.default)("input", config.input);
            if (/^(text|password|number|email|tel|url)$/.test(input.type)) input.classList.add("cm-textfield");
            if (!input.name) input.name = "input";
            content.appendChild((0, _creltDefault.default)("label", (config.label || "") + ": ", input));
        } else content.appendChild(document.createTextNode(config.label || ""));
        content.appendChild(document.createTextNode(" "));
        content.appendChild((0, _creltDefault.default)("button", {
            class: "cm-button",
            type: "submit"
    ...
    let panel = (0, _creltDefault.default)("div", content, (0, _creltDefault.default)("button", {
        onclick: ()=>done(null),
...
},{"@codemirror/state":"axaOu","style-mod":"gKx2e","w3c-keyname":"6ZDA5","crelt":"572SL","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"axaOu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@marijn/find-cluster-break":"8AlfQ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AlfQ":[function(require,module,exports,__globalThis) {
...
},{}],"gKx2e":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6ZDA5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"572SL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5nDyv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"axaOu","@codemirror/view":"c2noD","@codemirror/language":"dx7XI","@lezer/common":"6f22T","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dx7XI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@lezer/common":"6f22T","@codemirror/state":"axaOu","@codemirror/view":"c2noD","@lezer/highlight":"5AwBv","style-mod":"gKx2e","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6f22T":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5AwBv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@lezer/common":"6f22T","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequiree354", {})

//# sourceMappingURL=gilpgedit.github.io.31b563d9.js.map
